...
interface Props {
  ...
  basePath: string; // e.g., "/dashboard" or "/dashboard/recurrentes"
}

export function MonthSelectorGeneric({ month, basePath }: Props) {
  ...
  return (
    ...
    >
      ...
      >
        {capitalized}
        {isCurrentMonth && (
          <span style={{ fontSize: 10, color: "var(--haccent)", marginLeft: 4, opacity: 0.7 }}>
            actual
          </span>
        )}
      </span>
